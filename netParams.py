...
tjParams= netParams.importCellParams(label= 'foo', conds= {'bar':'baz'}, fileName= 'cells.py' , cellName= 'npTJ'  )
sParams = netParams.importCellParams(label= 'foo', conds= {'bar':'baz'}, fileName= 'cells.py' , cellName= 'npSoma')
